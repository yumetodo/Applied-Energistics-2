...
public abstract class EntityEquipmentInvWrapper implements IItemHandlerModifiable
{
    ...
    public static IItemHandlerModifiable[] create(LivingEntity entity)
    {
        IItemHandlerModifiable[] ret = new IItemHandlerModifiable[3];
        ret[0] = new EntityHandsInvWrapper(entity);
        ret[1] = new EntityArmorInvWrapper(entity);
        ret[2] = new CombinedInvWrapper(ret[0], ret[1]);
        return ret;
    }
}
