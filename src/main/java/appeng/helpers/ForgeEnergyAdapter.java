...
public class ForgeEnergyAdapter implements IEnergyStorage {
    ...
    public final int receiveEnergy(int maxReceive, boolean simulate) {
        ...
        final double overflow = this.sink.injectExternalPower(PowerUnits.TR, offered,
    ...
    public final int getEnergyStored() {
        return (int) Math.floor(PowerUnits.AE.convertTo(PowerUnits.TR, this.sink.getAECurrentPower()));
    }

    @Override
    public final int getMaxEnergyStored() {
        return (int) Math.floor(PowerUnits.AE.convertTo(PowerUnits.TR, this.sink.getAEMaxPower()));
    }
